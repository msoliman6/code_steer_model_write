...
figure recipe="code_builder":
    ...
    {{py}} -m code_steer_model_write.cli figure layers -o docs/media/layers-dark.svg --theme dark
    {{py}} -m code_steer_model_write.cli figure layers -o docs/media/layers.svg --theme light
